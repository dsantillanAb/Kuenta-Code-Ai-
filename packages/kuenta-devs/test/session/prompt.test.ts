import { ConfigV1 } from "@kuenta-devs/core/v1/config/config"
...
import { SessionMessageTable } from "@kuenta-devs/core/session/sql"
...
import { Shell } from "@kuenta-devs/core/shell"
import { Snapshot } from "../../src/snapshot"
import { ToolRegistry } from "@/tool/registry"
import { Truncate } from "@/tool/truncate"
import { CrossSpawnSpawner } from "@kuenta-devs/core/cross-spawn-spawner"
...
import { LocationServiceMap, locationServiceMapLayer } from "@kuenta-devs/core/location-services"
...
it.instance("does not loop empty assistant turns for a simple reply", () =>
  Effect.gen(function* () {
    ...
    yield* llm.text("packages/kuenta-devs/src/session/processor.ts")
