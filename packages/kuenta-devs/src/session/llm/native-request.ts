import type { JsonSchema, LLMRequest, ProviderMetadata } from "@kuenta-devs/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@kuenta-devs/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @kuenta-devs/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
