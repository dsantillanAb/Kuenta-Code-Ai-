...
import { llmClient } from "@kuenta-devs/core/effect/app-node-platform"
...
import type { LLMEvent } from "@kuenta-devs/llm"
import { LLMClient } from "@kuenta-devs/llm/route"
import type { LLMClientService } from "@kuenta-devs/llm/route"
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @kuenta-devs/llm. It
