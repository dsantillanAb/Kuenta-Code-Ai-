import type { Hooks, PluginInput } from "@kuenta-devs/plugin"
import type { Model } from "@kuenta-devs/sdk/v2"
import { InstallationVersion } from "@kuenta-devs/core/installation/version"
import { OauthCallbackPage } from "@kuenta-devs/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. Kuenta Devs will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
