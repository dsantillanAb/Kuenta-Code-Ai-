...
import { normalizePromptContent } from "@kuenta-devs/tui/editor"
...
import { OPENCODE_BASE_MODE, useBindings } from "@kuenta-devs/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Kuenta Devs" } satisfies SlashOption,
    ]
