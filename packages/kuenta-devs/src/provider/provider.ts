...
import { Hash } from "@kuenta-devs/core/util/hash"
...
import { optional } from "@kuenta-devs/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@kuenta-devs/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
      ...
      Effect.succeed({
        ...
        options: {
          headers: {
            "HTTP-Referer": "https://opencode.ai/",
            "X-Title": "opencode",
            "X-BILLING-INVOKE-ORIGIN": "Kuenta Devs",
          },
        },
      }),
    vercel: () =>
