...
import type { Config, OpencodeClient, Project } from "@kuenta-devs/sdk/v2/client"
import type { AgentApi, CatalogApi, CommandApi, ReferenceApi } from "@kuenta-devs/client/promise"
import type { NormalizedProviderListResponse } from "@kuenta-devs/session-ui/context"
import {
  bootstrapDirectory,
  loadAgentsQuery,
  loadCommands,
