...
beforeAll(async () => {
  ...
  mock.module("@kuenta-devs/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@kuenta-devs/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@kuenta-devs/ui/icon", () => ({ Icon: () => null }))
  mock.module("@kuenta-devs/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
