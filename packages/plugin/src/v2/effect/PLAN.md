...
- Effect plugins import `@kuenta-devs/plugin/v2/effect`, not `@kuenta-devs/core`.
- Public domain values use generated `@kuenta-devs/sdk` types.
...
- Define `PluginHost` domain capabilities in `@kuenta-devs/plugin/v2/effect`.
