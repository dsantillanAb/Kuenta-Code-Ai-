import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@kuenta-devs/sdk/v2"
import { SessionTurn } from "@kuenta-devs/session-ui/session-turn"
import { SessionReview } from "@kuenta-devs/session-ui/session-review"
import { DataProvider } from "@kuenta-devs/session-ui/context"
import { FileComponentProvider } from "@kuenta-devs/ui/context/file"
import { WorkerPoolProvider } from "@kuenta-devs/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@kuenta-devs/ui/logo"
import { IconButton } from "@kuenta-devs/ui/icon-button"
import { ProviderIcon } from "@kuenta-devs/ui/provider-icon"
import { iife } from "@kuenta-devs/core/util/iife"
import { Binary } from "@kuenta-devs/core/util/binary"
import { NamedError } from "@kuenta-devs/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@kuenta-devs/ui/tabs"
import { MessageNav } from "@kuenta-devs/session-ui/message-nav"
import { FileSSR } from "@kuenta-devs/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@kuenta-devs/session-ui/pierre/worker").then((m) => ({
