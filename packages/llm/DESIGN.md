...
> current private `@kuenta-devs/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@kuenta-devs/ai`
...
import { LLM } from "@kuenta-devs/ai"
import { OpenAI } from "@kuenta-devs/ai/providers/openai"
...
```ts
import { Message } from "@kuenta-devs/ai"
...
import { LLM, Tool } from "@kuenta-devs/ai"
...
```ts
import { LLM } from "@kuenta-devs/ai/promise"
import { OpenAI } from "@kuenta-devs/ai/providers/openai"
...
```ts
import { LLMSchema } from "@kuenta-devs/ai/schema"
...
```ts
import { Provider, Protocol } from "@kuenta-devs/ai/provider"
...
@kuenta-devs/ai/promise
  Promise/AsyncIterable LLM facade

@kuenta-devs/ai/schema
  serializable domain schemas

@kuenta-devs/ai/provider
  experimental Provider and Protocol authoring APIs

@kuenta-devs/ai/providers/openai
@kuenta-devs/ai/providers/anthropic
@kuenta-devs/ai/providers/google
...
```
...
| Current                                 | Proposed                                                    |
| --------------------------------------- | ----------------------------------------------------------- |
| `@kuenta-devs/llm`                      | `@kuenta-devs/ai`                                           |
