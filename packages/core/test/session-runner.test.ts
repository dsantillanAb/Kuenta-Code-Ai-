...
import {
  ...
  type LLMClientShape,
  type LLMRequest,
} from "@kuenta-devs/llm"
import * as OpenAIChat from "@kuenta-devs/llm/protocols/openai-chat"
import { Database } from "@kuenta-devs/core/database/database"
import { makeLocationNode } from "@kuenta-devs/core/effect/app-node"
...
import { EventTable } from "@kuenta-devs/core/event/sql"
import { Project } from "@kuenta-devs/core/project"
import { ProjectTable } from "@kuenta-devs/core/project/sql"
import { QuestionV2 } from "@kuenta-devs/core/question"
import { AbsolutePath } from "@kuenta-devs/core/schema"
import { SessionV2 } from "@kuenta-devs/core/session"
import { Snapshot } from "@kuenta-devs/core/snapshot"
import { ContextSnapshotDecodeError } from "@kuenta-devs/core/session/error"
import { SessionEvent } from "@kuenta-devs/core/session/event"
import { SessionInput } from "@kuenta-devs/core/session/input"
import { SessionMessage } from "@kuenta-devs/core/session/message"
import { Prompt } from "@kuenta-devs/core/session/prompt"
import { SessionProjector } from "@kuenta-devs/core/session/projector"
import { SessionExecution } from "@kuenta-devs/core/session/execution"
import { SessionRunCoordinator } from "@kuenta-devs/core/session/run-coordinator"
import { SessionRunner } from "@kuenta-devs/core/session/runner"
import * as SessionRunnerLLM from "@kuenta-devs/core/session/runner/llm"
import { SessionRunnerModel } from "@kuenta-devs/core/session/runner/model"
import { ToolRegistry } from "@kuenta-devs/core/tool/registry"
import { ApplicationTools } from "@kuenta-devs/core/tool/application-tools"
import { AgentV2 } from "@kuenta-devs/core/agent"
import { Config } from "@kuenta-devs/core/config"
import { ConfigCompaction } from "@kuenta-devs/core/config/compaction"
import { Tool } from "@kuenta-devs/core/tool/tool"
import {
  SessionContextEpochTable,
  SessionInputTable,
  SessionMessageTable,
  SessionTable,
} from "@kuenta-devs/core/session/sql"
import { SessionStore } from "@kuenta-devs/core/session/store"
import { SystemContext } from "@kuenta-devs/core/system-context"
import { SystemContextRegistry } from "@kuenta-devs/core/system-context/registry"
import { SkillGuidance } from "@kuenta-devs/core/skill/guidance"
import { ReferenceGuidance } from "@kuenta-devs/core/reference/guidance"
import { ModelV2 } from "@kuenta-devs/core/model"
import { Location } from "@kuenta-devs/core/location"
import { ProviderV2 } from "@kuenta-devs/core/provider"
