...
import type { Data, Definition, Payload } from "@kuenta-devs/schema/event"
...
import { Durable } from "@kuenta-devs/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@kuenta-devs/schema/event").ID
export type { Data, Definition, Payload } from "@kuenta-devs/schema/event"
