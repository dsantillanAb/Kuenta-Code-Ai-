...
import defaultSoundPath from "@kuenta-devs/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@kuenta-devs/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@kuenta-devs/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@kuenta-devs/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@kuenta-devs/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@kuenta-devs/ui/audio/yup-01.mp3" with { type: "file" }
