...
import { compile, emitEffectImported, emitPromise, write } from "@kuenta-devs/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@kuenta-devs/protocol/groups/event"',
            },
          },
        }),
