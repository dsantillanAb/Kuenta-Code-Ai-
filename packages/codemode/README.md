...
{
  "dependencies": {
    "@kuenta-devs/codemode": "workspace:*"
  }
}
```
...
```ts
import { CodeMode, Tool } from "@kuenta-devs/codemode"
...
```ts
import { CodeMode, OpenAPI } from "@kuenta-devs/codemode"
...
```ts
import { toolError } from "@kuenta-devs/codemode"
