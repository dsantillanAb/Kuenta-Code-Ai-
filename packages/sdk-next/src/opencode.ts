import { OpenCode } from "@kuenta-devs/client/effect"
...
import { createEmbeddedRoutes } from "@kuenta-devs/server/routes"
...
export class Service extends Context.Service<Service, Interface>()("@kuenta-devs/sdk-next/OpenCode") {}
