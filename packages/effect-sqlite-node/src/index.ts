...
export const TypeId: TypeId = "~@kuenta-devs/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@kuenta-devs/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@kuenta-devs/effect-sqlite-node/NodeSqliteClient")
