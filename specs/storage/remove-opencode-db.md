# Remove `packages/kuenta-devs/src/storage/db.ts`

## Goal

Remove all production usages of the legacy `packages/kuenta-devs/src/storage/db.ts` module.
...
Production imports from `packages/kuenta-devs/src/storage/db.ts` are concentrated in 22 source files:

- `packages/kuenta-devs/src/account/repo.ts`
- `packages/kuenta-devs/src/cli/cmd/db.ts`
- `packages/kuenta-devs/src/cli/cmd/import.ts`
- `packages/kuenta-devs/src/cli/cmd/stats.ts`
- `packages/kuenta-devs/src/control-plane/workspace.ts`
- `packages/kuenta-devs/src/index.ts`
- `packages/kuenta-devs/src/node.ts`
- `packages/kuenta-devs/src/permission/index.ts`
- `packages/kuenta-devs/src/project/project.ts`
- `packages/kuenta-devs/src/server/projectors.ts`
- `packages/kuenta-devs/src/server/routes/instance/httpapi/handlers/sync.ts`
- `packages/kuenta-devs/src/server/shared/fence.ts`
- `packages/kuenta-devs/src/session/message-v2.ts`
- `packages/kuenta-devs/src/session/projectors.ts`
- `packages/kuenta-devs/src/session/prompt.ts`
- `packages/kuenta-devs/src/session/session.ts`
- `packages/kuenta-devs/src/session/todo.ts`
- `packages/kuenta-devs/src/share/share-next.ts`
- `packages/kuenta-devs/src/storage/db.ts`
- `packages/kuenta-devs/src/sync/index.ts`
- `packages/kuenta-devs/src/worktree/index.ts`
...
Status: Completed. Startup, the public node export, and database CLI tooling no longer import the legacy opencode database wrapper; `packages/kuenta-devs/src/storage/db.ts` has been deleted.
...
All migration groups are complete or superseded. `packages/kuenta-devs/src/storage/db.ts` has been deleted.
...
- Existing schema ownership remains in `packages/core/src/**/*.sql.ts`; do not move table definitions back into `packages/kuenta-devs`.

## Verification Commands

- `rg "@/storage/db|./storage/db|Database\.(use|transaction|effect|Client|getPath)|\bTxOrDb\b|\bTransaction\b" packages/kuenta-devs/src`
- `bun typecheck` from `packages/kuenta-devs`
- Relevant package tests from `packages/kuenta-devs`, not the repo root
